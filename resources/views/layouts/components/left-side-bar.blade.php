    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <!-- <li>
                    <a href="{{ route('dashboard') }}" class="waves-effect waves-primary"><i
                            class="ti-home"></i><span> Dashboard </span></a>
                </li> -->

                <li>
                    <a href="{{ route('features') }}" class="waves-effect waves-primary"><i
                ...
                <li>
                    <a href="{{ route('history') }}" class="waves-effect waves-primary"><i
                            class="ti-receipt"></i><span> Order History </span></a>
                </li>
                <li>
                    <a href="{{ route('filters') }}" class="waves-effect waves-primary"><i
                            class="ti-receipt"></i><span> Filters </span></a>
                </li>
